...
export default function VolunteerProfilePage() {
  ...
  const volunteer = useVolunteerStore((state) => state.getVolunteer(volunteerId))
  const deleteVolunteer = useVolunteerStore((state) => state.deleteVolunteer)
  const attendances = useAttendanceStore((state) => state.getAttendancesByVolunteer(volunteerId))
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="text-center p-3 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-700">Tasa de Asistencia</p>
              </div>
            </div>
          </CardContent>
        </Card>
